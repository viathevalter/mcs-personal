...
const migrationsToRun = [
  ...
  '20260812140000_fix_worker_function_resolution_and_company_norm.sql',
  '20260813130000_fix_seguridade_status_allocations.sql',
  '20260813150000_auto_activate_workers_cron.sql'
];
