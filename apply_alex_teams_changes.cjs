...
const updatedAlexExecutiveHtml = `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="wrapper">
    <div class="main-card">
      ...
      <!-- Main Content -->
      <div class="content">
        <div class="greeting">Estimado/a cliente de {{company_name}}, ¿qué tal estáis?</div>
        
        <p>Me pongo en contacto con usted porque conocemos de primera mano uno de los principales desafíos que afrontan actualmente las empresas del sector industrial en España: la <strong>disponibilidad inmediata de profesionales técnicos homologados</strong>, sin asumir los costes fijos asociados a una contratación directa.</p>

        <div class="value-box">
          <p>⚡ Ponemos a su disposición <strong>brigadas y operarios altamente cualificados</strong>, preparados para incorporarse de forma inmediata en cualquier provincia de España, adaptándose a las necesidades de su proyecto y garantizando rapidez, flexibilidad y continuidad operativa.</p>
        </div>

        <p>En <strong>LUMINOUS</strong> cubrimos todas las especialidades técnicas que su taller u obra necesita:</p>
        ...
        <div class="grid-profiles">
          <div class="profile-item">
            ...
            <div class="profile-desc">TIG, MIG-MAG, Electrodo 6G (acero al carbono, inoxidable, dúplex y tubería de alta presión).</div>
          </div>
          
          <div class="profile-item">
            <div class="profile-title">🚰 2. Tuberos</div>
            <div class="profile-desc">Lectura e interpretación de planos isométricos, trazado, conformado y montajes piping en planta.</div>
          </div>
          ...
          <div class="profile-item">
            ...
            <div class="profile-desc">Montaje mecánico, estructuras metálicas, alineación y mantenimiento de plantas industriales.</div>
          </div>

          <div class="profile-item">
            <div class="profile-title">⚡ 5. Electricistas</div>
            <div class="profile-desc">Cuadros de control, cableado de potencia, conexionado e instalaciones industriales.</div>
          </div>

          <div class="profile-item">
            <div class="profile-title">🔧 6. Mecánicos</div>
            <div class="profile-desc">Mantenimiento predictivo, correctivo, ajuste y reparación de maquinaria industrial.</div>
          </div>

          <div class="profile-item">
            <div class="profile-title">🤖 7. Electromecánicos</div>
            <div class="profile-desc">Integración mecánica, eléctrica, neumática y puesta en marcha de líneas de producción.</div>
          </div>
          ...
          <div class="profile-item" style="background-color: #f8fafc; border-style: dashed;">
            ...
            <div class="profile-desc">Disponibilidad de capataces, jefes de equipo y especialistas a medida según su proyecto.</div>
          </div>
        </div>
...
async function applyAlexChanges() {
  ...
  `, [updatedAlexExecutiveHtml, empresaId, tmplTitle]);

  console.log('✅ Template atualizado com 100% das alterações solicitadas pelo Alex no Teams!');
