...
serve(async (req) => {
  ...
  try {
    ...
    const mergeData = {
      ...
      ALCANCE_ACORDADO: isFixedPrice ? (est.fixed_price_notes || defaultAlcance) : "",
      CONDICIONES_TECNICAS: isFixedPrice ? (est.fixed_price_notes || defaultAlcance) : "",
      MODIFICACIONES_RETRASOS: isFixedPrice ? defaultModificaciones : "",
      MODIFICACIONES_AMPLIACIONES_RETRASOS: isFixedPrice ? defaultModificaciones : "",
      CLAUSULA_DESVIACIONES: isFixedPrice ? defaultModificaciones : "",
