-- ==============================================================================
-- Migração Evolutiva - Bloco 3: Registro General (Master Data) - VERSÃO 2
-- ==============================================================================
...
-- Function utilitária para updated_at (Criada no schema public ou common)
...
-- ------------------------------------------------------------------------------
-- NOTA TÉCNICA: Esta tabela é estrutural. A inserção dos logs deverá ser 
-- disparada via camada da aplicação/API ou triggers customizados implementados
-- individualmente em fase posterior, para evitar lock excessivo do banco.
...
-- (Exige que a função has_role verifique no user_memberships)
