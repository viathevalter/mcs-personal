-- ========================================================================================
-- Migration: 20260916231000_fix_estimacion_versions_status_constraint.sql
-- Description: Fix estimacion_versions status constraint and ensure criar_estimacion_completa
--              and atualizar_estimacion_completa set version status to 'active' and use correct columns.
-- ========================================================================================

BEGIN;

-- 1. Ampliar a constraint de status em estimacion_versions para aceitar 'active', 'archived', 'draft'
ALTER TABLE core_comercial.estimacion_versions 
DROP CONSTRAINT IF EXISTS estimacion_versions_status_check;

ALTER TABLE core_comercial.estimacion_versions 
ADD CONSTRAINT estimacion_versions_status_check 
CHECK (status IN ('active', 'archived', 'draft'));

-- 2. Atualizar RPC criar_estimacion_completa
...
BEGIN
    ...
    -- Atualizar totais na Versão (colunas: total_cost, total_revenue, margin_percent)
...
-- 3. Atualizar RPC atualizar_estimacion_completa
