-- Migration: 20260610100000_add_individual_weekday_hours.sql
-- Description: Add individual weekday hours columns to estimaciones, pedidos and comercial_settings, and update RPCs.

BEGIN;

-- 1. Alterar tabelas para adicionar colunas de horas individuais por dia de semana
ALTER TABLE core_comercial.estimaciones
ADD COLUMN IF NOT EXISTS hours_lunes numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS hours_martes numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS hours_miercoles numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS hours_jueves numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS hours_viernes numeric(5,2) NOT NULL DEFAULT 8.0;
...
ADD COLUMN IF NOT EXISTS default_hours_lunes numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS default_hours_martes numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS default_hours_miercoles numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS default_hours_jueves numeric(5,2) NOT NULL DEFAULT 8.0,
ADD COLUMN IF NOT EXISTS default_hours_viernes numeric(5,2) NOT NULL DEFAULT 8.0;
