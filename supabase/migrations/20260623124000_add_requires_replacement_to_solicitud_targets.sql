-- Migration: 20260623124000_add_requires_replacement_to_solicitud_targets.sql
-- Description: Add requires_replacement column to core_operacoes.solicitud_targets and update RPC to handle it.

-- 1. Add requires_replacement column if it does not exist
ALTER TABLE core_operacoes.solicitud_targets ADD COLUMN IF NOT EXISTS requires_replacement BOOLEAN DEFAULT true;
