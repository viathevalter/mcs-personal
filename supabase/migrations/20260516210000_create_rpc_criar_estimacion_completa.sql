-- ========================================================================================
-- MIGRATION: RPC CRIAR ESTIMACION COMPLETA
-- Objetivo: Salvar Estimacion, Versão e Itens em uma transação única (atômica).
-- ========================================================================================
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO core_comercial.estimacion_items (
            empresa_id, estimacion_version_id, job_function_id,
            ...
            v_empresa_id, v_version_id, (v_item->>'job_function_id')::uuid,
        ...
        -- Opcional: Somar os totais via Payload ou calculando
        -- Vamos pegar do payload para garantir que bate com o frontend
    END LOOP;
