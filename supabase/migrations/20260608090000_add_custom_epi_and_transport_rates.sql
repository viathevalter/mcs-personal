-- ========================================================================================
-- Migration: 20260608090000_add_custom_epi_and_transport_rates.sql
-- Description: Add custom_epi_rate and custom_transport_rate columns to estimacion_items and pedido_items,
--              and update RPCs to handle these columns.
-- ========================================================================================

BEGIN;

-- 1. Alterar tabelas para incluir as novas colunas
ALTER TABLE core_comercial.estimacion_items
ADD COLUMN IF NOT EXISTS custom_epi_rate NUMERIC(10,2) DEFAULT NULL,
ADD COLUMN IF NOT EXISTS custom_transport_rate NUMERIC(10,2) DEFAULT NULL;

ALTER TABLE core_comercial.pedido_items
ADD COLUMN IF NOT EXISTS custom_epi_rate NUMERIC(10,2) DEFAULT NULL,
ADD COLUMN IF NOT EXISTS custom_transport_rate NUMERIC(10,2) DEFAULT NULL;

-- 2. Atualizar a função criar_estimacion_completa
...
-- 3. Atualizar a função atualizar_estimacion_completa
...
BEGIN
    ...
    -- 9. Clonar os Itens para o Pedido (incluindo ss_regime, custom_lodging_rate, custom_epi_rate, custom_transport_rate)
