-- ========================================================================================
-- MIGRATION: RPC APROVAR ESTIMACIÓN V2
-- Objetivo: Converter uma estimación aprovada em um pedido operacional completo e acionar
-- o motor de playbooks.
-- ========================================================================================
...
BEGIN
    ...
    -- 5. Validar itens (Ajustado para estimacion_version_id)
    ...
    -- TODO: No futuro, substituir essa geração por sequence segura por empresa para evitar colisão de concorrência.
    ...
    -- 9. Clonar os Itens para o Pedido (Ajustado para estimacion_version_id)
    ...
    -- TODO: No futuro, substituir essa geração por sequence segura por empresa.
