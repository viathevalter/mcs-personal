...
DROP FUNCTION IF EXISTS core_personal.get_salary_report_workers(uuid, integer, integer, text, text, text[], text, text, integer, integer, text[]);
DROP FUNCTION IF EXISTS core_personal.get_salary_report_kpis(uuid, integer, integer, text, text, text[]);
DROP FUNCTION IF EXISTS core_personal.get_salary_report_kpis(uuid, integer, integer, text, text, text[], text[]);

-- 2. CREATE core_personal.get_salary_report_workers WITH status filter
...
-- 3. CREATE core_personal.get_salary_report_kpis WITH status filter
...
-- 4. GRANT PERMISSIONS
GRANT ALL ON FUNCTION core_personal.get_salary_report_workers(uuid, integer, integer, text, text, text[], text, text, integer, integer, text[]) TO anon, authenticated, service_role;
GRANT ALL ON FUNCTION core_personal.get_salary_report_kpis(uuid, integer, integer, text, text, text[], text[]) TO anon, authenticated, service_role;
