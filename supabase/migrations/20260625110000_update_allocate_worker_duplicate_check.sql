-- Redefine core_personal.alocar_trabalhador_em_vaga to enforce duplicate document check on new worker creation
...
BEGIN
    ...
    INSERT INTO core_personal.worker_assignments (
        id, empresa_id, worker_id, pedido_item_id, client_id, client_site_id,
