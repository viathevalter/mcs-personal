-- ========================================================================================
-- MIGRATION: RPC APROVAR ESTIMACIÓN
...
BEGIN
    ...
    -- 2. Validar Permissões (super_admin, admin ou operador)
    IF NOT (
        core_common.has_role(v_est.empresa_id, 'super_admin')
        OR core_common.has_role(v_est.empresa_id, 'admin')
    ...
    WHERE version_id = v_est.current_version_id;
