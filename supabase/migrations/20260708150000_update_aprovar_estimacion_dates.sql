-- Migration: 20260708150000_update_aprovar_estimacion_dates.sql
-- Description: Updates core_comercial.aprovar_estimacion to accept custom start and end dates when generating orders.

BEGIN;

DROP FUNCTION IF EXISTS core_comercial.aprovar_estimacion(UUID);
