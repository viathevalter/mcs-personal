-- ========================================================================================
-- Migration: 20260608100000_add_manager_approval_to_estimaciones.sql
-- Description: Add is_approved_by_manager column to estimaciones,
--              and update atualizar_estimacion_completa RPC to reset it on edit.
-- ========================================================================================

BEGIN;

-- 1. Alterar tabela estimaciones para incluir a flag de aprovação do gerente
ALTER TABLE core_comercial.estimaciones
ADD COLUMN IF NOT EXISTS is_approved_by_manager BOOLEAN DEFAULT FALSE;
...
BEGIN
    ...
    -- 5. Atualizar Estimación (reseta a aprovação do gerente se for editada)
