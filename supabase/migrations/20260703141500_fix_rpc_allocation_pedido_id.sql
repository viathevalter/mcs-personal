-- Redefine core_personal.alocar_trabalhador_em_vaga to include pedido_id in worker_assignments insert
...
BEGIN
    ...
    INSERT INTO core_personal.worker_assignments (
        id, empresa_id, worker_id, pedido_item_id, pedido_id, client_id, client_site_id,
    ...
    SET status_operacional = v_new_operational_status
