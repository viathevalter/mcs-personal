-- 1. Redefinir core_personal.get_client_worker_kpis com a mesma lógica de empresa de search_workers e alta performance
...
-- 2. Otimizar search_workers para usar COALESCE com w.cliente e rodar instantaneamente
