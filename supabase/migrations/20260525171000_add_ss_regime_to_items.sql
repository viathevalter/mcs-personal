-- ========================================================================================
-- Migration: 20260525171000_add_ss_regime_to_items.sql
-- Description: Add ss_regime and custom_lodging_rate to estimacion_items and pedido_items, and update PL/pgSQL functions.
-- ========================================================================================

BEGIN;

-- 1. Alterar a tabela core_comercial.estimacion_items
ALTER TABLE core_comercial.estimacion_items 
ADD COLUMN IF NOT EXISTS ss_regime VARCHAR(50) DEFAULT 'local',
ADD COLUMN IF NOT EXISTS custom_lodging_rate NUMERIC(10,2) DEFAULT NULL;

-- 2. Alterar a tabela core_comercial.pedido_items
