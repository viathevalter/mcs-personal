-- Migration: 20260618162000_allow_signed_on_aprovar_estimacion.sql
-- Description: Allows estimations in 'signed' status to be approved and converted to pedidos.
