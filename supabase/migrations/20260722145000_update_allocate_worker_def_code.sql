-- Redefine core_personal.alocar_trabalhador_em_vaga to generate next sequential cod_colab immediately
...
BEGIN
    ...
    IF v_worker_id IS NULL THEN
        ...
        -- NOTE: dropped empresa_id column from core_personal.workers
