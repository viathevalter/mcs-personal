-- Adicionar a coluna postal_code na tabela core_comercial.estimaciones
ALTER TABLE core_comercial.estimaciones ADD COLUMN IF NOT EXISTS postal_code VARCHAR(10) NULL;

-- Adicionar a coluna is_auto na tabela core_comercial.estimacion_costs
ALTER TABLE core_comercial.estimacion_costs ADD COLUMN IF NOT EXISTS is_auto BOOLEAN DEFAULT false;

-- Atualizar a RPC core_comercial.criar_estimacion_completa para capturar postal_code e is_auto
