-- Migration: 20260817170500_expose_salvar_evento_holerite_public.sql
-- Description: Expose salvar_evento_holerite in public schema for PostgREST RPC access

CREATE OR REPLACE FUNCTION public.salvar_evento_holerite(
    p_worker_id UUID,
...
GRANT EXECUTE ON FUNCTION public.salvar_evento_holerite TO authenticated, anon, service_role;
