...
export function calculateHoleriteRegularizacao(options: {
    ...
    return {
        ...
        descontos: {
            ...
            aluguelCarros: descontosParsed.aluguelCarros,
            taxasBancarias: descontosParsed.taxasBancarias,
            imposto: descontosParsed.imposto,
            descontosAdicionais: descontosParsed.descontosAdicionais,
            totalDescontos: descontosParsed.totalDescontosDetalhados,
        },
        totalLiquido,
