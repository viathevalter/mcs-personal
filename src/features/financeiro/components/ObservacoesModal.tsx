...
export const ObservacoesModal: React.FC<ObservacoesModalProps> = ({ titulo, isOpen, onClose }) => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            toast.error('Erro ao carregar a linha do tempo.');
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-6xl flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div className="flex justify-between items-center bg-brand-primary p-4 text-white">
                    <h2 className="text-xl font-semibold tracking-tight">Observações e Histórico</h2>
                ...
                <div className="p-4 bg-gray-50 border-b flex flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-3 bg-white p-3 rounded-lg border shadow-sm flex-1 min-w-[250px]">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold truncate" title={cliente?.EmailCobros || 'Sem E-mail'}>{cliente?.EmailCobros || 'Sem E-mail'}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 bg-white p-3 rounded-lg border shadow-sm flex-1 min-w-[200px]">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold truncate">{cliente?.TelefonoCobros || 'Sem Telefone'}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-white">
                    <h3 className="text-lg font-medium text-center text-brand-dark mb-8 border-b pb-2">Linha do Tempo</h3>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center py-12 text-gray-500 flex flex-col items-center">
                            ...
                            <p>Nenhum histórico registrado para este documento.</p>
                        </div>
                    ) : (
                ...
                <div className="bg-gray-50 border-t p-4 flex gap-2">
                    <Input 
                        ...
                        placeholder="Adicionar nova observação ou registro de contato..."
                        className="flex-1"
                        onKeyDown={(e) => {
